...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/fiat-alignment-1.jpg').to_s),
                          filename: 'fiat-alignment-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/fiat-alignment-2.jpg').to_s),
...
maintenance = Maintenance.create(date: Date.parse('20210812'), description: 'Oil Change', vendor: 'Jiffy Lube',
                                 cost: '78.00', car_id: 1)
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/fiat-oil-change-1.jpg').to_s),
                          filename: 'fiat-oil-change-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/fiat-oil-change-2.jpg').to_s),
...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/civic-brake-repair-1.jpg').to_s),
                          filename: 'civic-brake-repair-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/civic-brake-repair-2.jpg').to_s),
...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/civic-tire-rotation-1.jpg').to_s),
                          filename: 'civic-tire-rotation-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/civic-tire-rotation-2.jpg').to_s),
...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/elantra-new-tires-1.jpg').to_s),
                          filename: 'elantra-new-tires-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/elantra-new-tires-2.jpg').to_s),
...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/elantra-repaired-body-1.jpg').to_s),
                          filename: 'elantra-repaired-body-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/elantra-repaired-body-2.jpg').to_s),
...
maintenance.images.attach(
  io: URI.open(Rails.root.join('app/assets/images/maintenances/leaf-windshield-replacement-1.jpg').to_s), filename: 'leaf-windshield-replacement-1.jpg'
)
maintenance.images.attach(
  io: URI.open(Rails.root.join('app/assets/images/maintenances/leaf-windshield-replacement-2.jpg').to_s), filename: 'leaf-windshield-replacement-2.jpg'
)
maintenance.save!
...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/leaf-new-spark-plugs-1.jpg').to_s),
                          filename: 'leaf-new-spark-plugs-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/leaf-new-spark-plugs-2.jpg').to_s),
...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/scion-engine-overhaul-1.jpg').to_s),
                          filename: 'scion-engine-overhaul-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/scion-engine-overhaul-2.jpg').to_s),
...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/scion-5k-mile-maintenance-1.jpg').to_s),
                          filename: 'scion-5k-mile-maintenance-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/scion-5k-mile-maintenance-2.jpg').to_s),
...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/camry-fuel-line-1.jpg').to_s),
                          filename: 'camry-fuel-line-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/camry-fuel-line-2.jpg').to_s),
...
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/camry-replaced-radiator-1.jpg').to_s),
                          filename: 'camry-replaced-radiator-1.jpg')
maintenance.images.attach(io: URI.open(Rails.root.join('app/assets/images/maintenances/camry-replaced-radiator-2.jpg').to_s),
