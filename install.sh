...
RSpec.describe "/documents", type: :request do
  ...
  before :each do
    ...
    # @fiat_alignment_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'fiat-alignment-1.png'),'image/png'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'fiat-alignment-1.png'),'image/png')])
    # @fiat_alignment_document_2 = documents(:fiat_alignment_document_2)
    # @fiat_alignment_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'fiat-alignment-2.txt'),'text/plain'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'fiat-alignment-2.txt'),'text/plain')])
    # @fiat_oil_change_document_1 = documents(:fiat_oil_change_document_1)
    # @fiat_oil_change_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'fiat-oil-change-1.txt'),'text/plain'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'fiat-oil-change-1.txt'),'text/plain')])
    # @fiat_oil_change_document_2 = documents(:fiat_oil_change_document_2)
    # @fiat_oil_change_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'fiat-oil-change-2.txt'),'text/plain'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'fiat-oil-change-2.txt'),'text/plain')])
    # @civic_brake_repair_document_1 = documents(:civic_brake_repair_document_1)
    # @civic_brake_repair_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'civic-brake-repair-1.jpg'),'image/jpeg'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'civic-brake-repair-1.jpg'),'image/jpeg')])
    # @civic_brake_repair_document_2 = documents(:civic_brake_repair_document_2)
    # @civic_brake_repair_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'civic-brake-repair-2.pdf'),'text/plain'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'civic-brake-repair-2.pdf'),'text/plain')])
    # @civic_tire_rotation_document_1 = documents(:civic_tire_rotation_document_1)
    # @civic_tire_rotation_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'civic-tire-rotation-1.pdf'),'application/png'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'civic-tire-rotation-1.pdf'),'application/png')])
    # @civic_tire_rotation_document_2 = documents(:civic_tire_rotation_document_2)
    # @civic_tire_rotation_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'civic-tire-rotation-2.png'),'image/png'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'civic-tire-rotation-2.png'),'image/png')])
    # @elantra_new_tires_document_1 = documents(:elantra_new_tires_document_1)
    # @elantra_new_tires_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'elantra-new-tires-1.pdf'),'application/pdf'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'elantra-new-tires-1.pdf'),'application/pdf')])
    # @elantra_new_tires_document_2 = documents(:elantra_new_tires_document_2)
    # @elantra_new_tires_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'elantra-new-tires-2.pdf'),'application/pdf'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'elantra-new-tires-2.pdf'),'application/pdf')])
    # @elantra_repaired_body_document_1 = documents(:elantra_repaired_body_document_1)
    # @elantra_repaired_body_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'elantra-repaired-body-1.png'),'image/png'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'elantra-repaired-body-1.png'),'image/png')])
    # @elantra_repaired_body_document_2 = documents(:elantra_repaired_body_document_2)
    # @elantra_repaired_body_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'elantra-repaired-body-2.pdf'),'application/pdf'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'elantra-repaired-body-2.pdf'),'application/pdf')])
    # @leaf_windshield_replacement_document_1 = documents(:leaf_windshield_replacement_document_1)
    # @leaf_windshield_replacement_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'leaf-windshield-replacement-1.webp'),'image/webp'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'leaf-windshield-replacement-1.webp'),'image/webp')])
    # @leaf_windshield_replacement_document_2 = documents(:leaf_windshield_replacement_document_2)
    # @leaf_windshield_replacement_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'leaf-windshield-replacement-2.webp'),'image/webp'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'leaf-windshield-replacement-2.webp'),'image/webp')])
    # @leaf_new_spark_plugs_document_1 = documents(:leaf_new_spark_plugs_document_1)
    # @leaf_new_spark_plugs_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'leaf-new-spark-plugs-1.txt'),'text/plain'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'leaf-new-spark-plugs-1.txt'),'text/plain')])
    # @leaf_new_spark_plugs_document_2 = documents(:leaf_new_spark_plugs_document_2)
    # @leaf_new_spark_plugs_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'leaf-new-spark-plugs-2.png'),'image/png'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'leaf-new-spark-plugs-2.png'),'image/png')])
    # @scion_engine_overhaul_document_1 = documents(:scion_engine_overhaul_document_1)
    # @scion_engine_overhaul_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'scion-engine-overhaul-1.png'),'image/png'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'scion-engine-overhaul-1.png'),'image/png')])
    # @scion_engine_overhaul_document_2 = documents(:scion_engine_overhaul_document_2)
    # @scion_engine_overhaul_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'scion-engine-overhaul-2.jpg'),'image/jpeg'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'scion-engine-overhaul-2.jpg'),'image/jpeg')])
    # @scion_5k_mile_maintenance_document_1 = documents(:scion_5k_mile_maintenance_document_1)
    # @scion_5k_mile_maintenance_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'scion-5k-mile-maintenance-1.jpg'),'image/jpeg'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'scion-5k-mile-maintenance-1.jpg'),'image/jpeg')])
    # @scion_5k_mile_maintenance_document_2 = documents(:scion_5k_mile_maintenance_document_2)
    # @scion_5k_mile_maintenance_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'scion-5k-mile-maintenance-2.png'),'image/png'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'scion-5k-mile-maintenance-2.png'),'image/png')])
    # @camry_fuel_line_document_1 = documents(:camry_fuel_line_document_1)
    # @camry_fuel_line_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'camry-fuel-line-1.txt'),'text/plain'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'camry-fuel-line-1.txt'),'text/plain')])
    # @camry_fuel_line_document_2 = documents(:camry_fuel_line_document_2)
    # @camry_fuel_line_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'camry-fuel-line-2.webp'),'image/webp'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'camry-fuel-line-2.webp'),'image/webp')])
    # @camry_replaced_radiator_document_1 = documents(:camry_replaced_radiator_document_1)
    # @camry_replaced_radiator_document_1.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'camry-replaced-radiator-1.png'),'image/png'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'camry-replaced-radiator-1.png'),'image/png')])
    # @camry_replaced_radiator_document_2 = documents(:camry_replaced_radiator_document_2)
    # @camry_replaced_radiator_document_2.attachment.attach([fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'camry-replaced-radiator-2.webp'),'image/webp'), fixture_file_upload(Rails.root.join('spec', 'fixtures', 'files', 'camry-replaced-radiator-2.webp'),'image/webp')])
  end
