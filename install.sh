...
cp ~/Desktop/rux-drivetracks/assets/challenger.png ~/Desktop/rux-drivetracks/front/assets/images
...
cat <<'EOF' | puravida cypress.config.js ~
...
cat <<'EOF' | puravida cypress/fixtures/example.json ~
{
...
cat <<'EOF' | puravida cypress/support/e2e.js ~
// ***********************************************************
